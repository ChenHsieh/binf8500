...
// script for testing
// g++ -std=c++11 -o ch29576PSSM_char -Wall ch29576PSSM_char.cpp; time ./ch29576PSSM_char FruR.txt ecoK12-MG1655.fasta
// g++ -std=c++11 -O3 -o ch29576PSSM_char -Wall ch29576PSSM_char.cpp; time ./ch29576PSSM_char FruR.txt ecoK12-MG1655.fasta > zzz.txt;
// g++ -std=c++11 -O3 -o ch29576PSSM_char -Wall ch29576PSSM_char.cpp; time ./ch29576PSSM_char sigma54.txt ecoK12-MG1655.fasta > zzz.txt;
// g++ -std=c++11 -O3 -o ch29576PSSM_char -Wall ch29576PSSM_char.cpp; time ./ch29576PSSM_char FruR.txt Scel-So0157-2.fasta > zzz.txt;
// g++ -std=c++11 -O3 -o ch29576PSSM_char -Wall ch29576PSSM_char.cpp; time ./ch29576PSSM_char sigma54.txt Scel-So0157-2.fasta > zzz.txt;
